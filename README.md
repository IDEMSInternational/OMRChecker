...
Check alignment: `python3 batch_process.py -i inputs/sheet_small_markers --setLayout`

Grade sheets in folder: `python3 batch_process.py -i inputs/sheet_small_markers`
